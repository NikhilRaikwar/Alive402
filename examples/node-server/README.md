...
Install `@nikhilraikwar/alive402-sdk`, create a persistent `Alive402Store`, implement World enrollment routes, then wrap an ordinary Fetch handler with `withAlive402()` as shown in [SDK.md](../../docs/SDK.md).
